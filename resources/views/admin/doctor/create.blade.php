            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('doctor.index') }}">Administrator</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" name="education"
                                    ...
                                    placeholder="Student / College / University" value="{{ old('education') }}">
                                @error('education')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="department"
                                        ...
                                        placeholder="School / College / University Name" value="{{ old('department') }}">
